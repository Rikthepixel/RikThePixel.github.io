...
Brave and Firefox are browsers that likely don't want to implement it.

_(Show Brave, Vivaldi and Firefox statements)_

However because Chromium is such a large part of the browser market they will have to implement it, otherwise they will risk their users not being able to surf the web.

_(Show market share chromium based browsers)_
