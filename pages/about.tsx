            ...
            <div className="w-full h-full overflow-auto">
                <div className="flex flex-col w-full max-w-7xl mx-auto gap-16 py-16 md:gap-24 md:py-24">
                    ...
                    <section className="p-4" aria-labelledby="experience">
                        <h2 id="experience" className="text-4xl font-medium text-center md:text-5xl">Experience</h2>
                        <motion.div
                        ...
                        >
                            {experiences.map((experience, i, arr) => (
                                <motion.div
                                    key={i}
                                    variants={(reduceMotion || initialLoad) ? {} : experienceAnimation}
                                >
                                    <Experience
                    ...
                    <section className="flex flex-col items-center gap-4 p-4" aria-labelledby="external-links">
                        <h2 id="external-links" className="text-4xl font-medium text-center md:text-5xl">External Links</h2>
                        <div className="flex flex-col gap-4">
